					...
					Headers: []*envoy_api_v3_core.HeaderValueOption{
						...
						},
						{
							...
							Header: &envoy_api_v3_core.HeaderValue{
								...
								// x-current-user value.
								Key:   "x-token",
								Value: req.Attributes.Request.Http.Headers["x-id-token"],
							},
						},
					},
					ResponseHeadersToAdd: []*envoy_api_v3_core.HeaderValueOption{
						{
							Append: &wrappers.BoolValue{Value: false},
							Header: &envoy_api_v3_core.HeaderValue{
								// Whatever comes in the msg header is copied to the response
								Key:   "x-response-header",
								Value: req.Attributes.Request.Http.Headers["msg"],
							},
						},
					},
				},
