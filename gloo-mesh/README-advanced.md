...
helm install gloo glooe/gloo-ee --namespace gloo-system --create-namespace --version=1.7.1 --set-string license_key=$LICENSE_KEY --set global.istioSDS.enabled=true --set gloo.gatewayProxies.gatewayProxy.istioMetaMeshId=mesh1 --set gloo.gatewayProxies.gatewayProxy.IstioMetaClusterId=cluster1
